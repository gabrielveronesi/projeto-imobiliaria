//#region Script menu lateral mobile
$(function () {
  'use strict'
...
let urlListaConfig = 'https://localhost:5001/cliente-autenticado/listar-configuracoes';
const auth = {
...
axios.get(urlListaConfig, auth)
  .then(function (response) {
    ...
    document.getElementById("atualizaNome").innerHTML = '<div class="input-group mb-3">' +
      ...
      '</div>' +
      '<input type="text" class="form-control" id="inputNome" value="' + result.nome + '" placeholder="' + result.nome + '" required maxlength="40">' +
      '</div>'
    ...
    document.getElementById("atualizaSobre").innerHTML = '<div class="input-group">' +
      ...
      '</div>' +
      '<textarea class="form-control" id="inputSobre" aria-label="Com textarea" maxlength="500">' + result.sobre + '</textarea>' +
      '</div>'
    ...
    document.getElementById("atualizaTexto").innerHTML = '<div class="input-group">' +
      ...
      '</div>' +
      '<textarea class="form-control" id="inputTexto" aria-label="Com textarea" maxlength="100">' + result.texto + '</textarea>' +
      '</div>'
    ...
    document.getElementById("atualizaContatos").innerHTML =
      ...
      '</div>' +
      '<input type="text" class="form-control" id="inputFacebook" aria-describedby="basic-addon3" value="' + result.facebook + '" placeholder="' + result.facebook + '" maxlength="100">' +
      '</div>' +
      //Instagram
      '<div class="input-group mb-3">' +
      '<div class="input-group-prepend">' +
      ...
      '</div>' +
      '<input type="text" class="form-control" id="inputInstagram" aria-describedby="basic-addon3" value="' + result.instagram + '" placeholder="' + result.instagram + '" maxlength="100">' +
      '</div>' +
      //WhatsApp
      '<div class="input-group mb-3">' +
      '<div class="input-group-prepend">' +
